<x-admin-layout>
	...
	<x-slot name="header">
      <a class="btn btn-primary" href="{{ route('admin.usersmanagement') }}">Back</a>
    </x-slot>
							...
							<div class="col-lg-8 push-lg-4 personal-info">
							 ...
							 <input type="hidden" name="userId" value="{{ @$userManageDetails['id'] }}">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9">
									@foreach($userManageDetails->roles as $roles)
									
										<input class="form-control" name="zipcode" type="text" value="{{$roles['name']}}" readonly>
									@endforeach
									</div>
								</div>
